...
...     print("Hello! This is Mingni's Tic-Tac-Toe game!")
...     print("\n")
...     print("Rules: Player 1 and Player 2, take turns "
...           "marking the spaces in a 3*3 grid. The player who succeeds in placing "
...           "three of their marks in a row wins.")
...     print("\n")
...
...     symbol_1 = input("Player 1, type X or O? ")
    if symbol_1 == "X":
        symbol_2 = "O"
...
def illegal(board, symbol_1, symbol_2, row, column):
    print("The square you picked is filled. Pick another one.")
